...
def main_for_evaluation():
    ...
    relation2id = {}
    id2relation = {}
    f = io.open('./origin_data/relation2id.txt', 'r', encoding='utf-8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    pathname = "./model/ATT_GRU_model_Health_15-"
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for model_iter in testlist:
                ...
                test_word = np.load('./data/Healthtestall_word.npy')
                test_pos1 = np.load('./data/Healthtestall_pos1.npy')
                test_pos2 = np.load('./data/Healthtestall_pos2.npy')
                allprob = []
                acc = []
...
def main(_):
    pathname = "./model/26/ATT_GRU_model_Health_-3000"
    wordembedding = np.load('./data/vec.npy')
    test_settings = network.Settings()
    test_settings.vocab_size = 16693
    test_settings.num_classes = 6
        ...
        with sess.as_default():
            ...
            while True:
                #try:
                    ...
                    #print("实体1: " + en1.decode("utf-8"))
                    #print("实体2: " + en2.decode("utf-8"))
